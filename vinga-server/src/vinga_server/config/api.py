...
API_DESCRIPTION = (
    ...
    "conversation when it opens, so an edited phrase reaches the next conversation and "
    "never changes what one already open is masking with; only an agent whose phrases "
    "or whose voice moved is synthesized again, and one whose synthesis failed applies "

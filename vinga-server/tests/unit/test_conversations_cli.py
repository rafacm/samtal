...
def run(tmp_path: Path, monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setenv("VINGA_SERVER__DATABASE__DIR", str(tmp_path))
...
def test_a_locked_store_is_the_retryable_refusal(
    ...
    import vinga_server.db as db_module
    from vinga_server.conversations.store import open_conversations
...
def test_a_driver_failure_says_the_kind_and_not_the_bytes(
    ...
    import vinga_server.conversations.store as store_module
...
def test_a_store_that_vanishes_after_the_check_is_still_a_sentence(
    ...
    import vinga_server.conversations.cli as cli_module

...
- The exact vocabulary of the two landed surfaces:
  ...
  stale here.
- Still open, each with its owner: erasing a named session or a named
  thread on demand (#190), exporters over the same tap and vocabulary (#66/#67), the

...
- The exact vocabulary of the two landed surfaces:
  ...
  stale here.
- Still open, each with its owner: the recap checkpoints of a resumed
  thread (#190, the milestone after resumption itself), exporters over

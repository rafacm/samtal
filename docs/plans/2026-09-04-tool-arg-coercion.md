...
- [x] **[M1: the coercion, wired and tested](2026-09-04-tool-arg-coercion-implementation.md#m1-the-coercion-wired-and-tested)** (PR [#389](https://github.com/rafacm/vinga/pull/389)). `tools/arguments.py`

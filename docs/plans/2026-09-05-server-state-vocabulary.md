...
- [x] **[M1: the boundary an acknowledgement announces, on the wire](2026-09-05-server-state-vocabulary-implementation.md#m1-the-boundary-an-acknowledgement-announces-on-the-wire)** (PR #409).

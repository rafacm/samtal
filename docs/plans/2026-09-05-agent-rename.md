...
- [x] **[M2: the order that covers the sessions in flight](2026-09-05-agent-rename-implementation.md#m2-the-order-that-covers-the-sessions-in-flight)** (PR TBD). The rename

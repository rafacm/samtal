...
- [x] **[M1: Pin the unpinned arms, then convert the loop to
  `match`](2026-08-22-match-dispatch-implementation.md#m1-pin-the-unpinned-arms-then-convert-the-loop-to-match).** (PR [#236](https://github.com/rafacm/vinga/pull/236)) Two code commits (the pin, then the conversion with its

...
- [x] **[M2: the sentence guard](2026-09-04-reply-failure-fallback-implementation.md#m2-the-sentence-guard)** (PR [#391](https://github.com/rafacm/vinga/pull/391)). The predicate in

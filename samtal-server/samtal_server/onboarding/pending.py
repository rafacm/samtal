...
configuration API and `samtal-server config` are this table's second
...
# always had: a test assigns `samtal_server.onboarding.MINT_BUDGET` and
...
import samtal_server.onboarding as onboarding

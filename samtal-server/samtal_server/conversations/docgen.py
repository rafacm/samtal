...
def reference() -> str:
    ...
    lines = [
        ...
        *_paragraph(
            ...
            "implied: a checkpoint blocked by a concurrent long reader truncates at "
            "the next quiet moment instead of failing the deletion, and copies that "
            "have already left the file (backups, filesystem snapshots) are the "
